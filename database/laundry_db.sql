...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2023 at 11:25 AM
...
INSERT INTO `laundry_categories` (`id`, `user_id`, `name`, `price`) VALUES
(1, 0, 'Bed Sheets', 30),
(3, 5, 'Clothes', 25),
(4, 4, 'sasasas', 3000);
...
(6, 'alex b kaindoy jr', 0, 1, 75, 0, 0, -75, 'asasasas', '2023-11-23 16:46:31');
